...
class ObjCHTTPClientGenerator(val typeTransformer: ObjCTypeTransformer,
  ...
  private fun addCancellableDependencyForService(service:Service, apiClass: ObjCComplexClass) {
  ...
  private fun addInitMethodForService(service: Service, apiClass: ObjCComplexClass) {
    ...
    apiClass.definition.addPropertyDefinition(ObjCProperty("version", ObjCType("NSString")))
    apiClass.definition.addPropertyDefinition(ObjCProperty("name", ObjCType("NSString")))
    apiClass.definition.addPropertyDefinition(ObjCProperty("httpClient", ObjCType(httpClientClassName)))
  ...
  private fun addServiceMethodForService(service: Service, apiClass: ObjCComplexClass, method: ServiceMethod, project: ObjCProjectComplex) {
//    val cancellableOperationClassName = this.cancelableOperationClassNameForService(service,this.generationOptions!!)
...
//    }
  ...
  private fun addDeserializationLogicForService(service:Service, apiClass: ObjCComplexClass) {
